package com.jiangyang.cloud.framework.ratelimiter.config;

import com.jiangyang.cloud.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.jiangyang.cloud.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.jiangyang.cloud.framework.ratelimiter.core.keyresolver.impl.*;
import com.jiangyang.cloud.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class JiangYangRateLimiterConfiguration {

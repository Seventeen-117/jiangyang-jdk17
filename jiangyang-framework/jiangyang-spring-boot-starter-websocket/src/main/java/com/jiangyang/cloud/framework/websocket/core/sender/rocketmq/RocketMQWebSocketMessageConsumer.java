package com.jiangyang.cloud.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${jiangyang.websocket.sender-rocketmq.topic}",
        consumerGroup = "${jiangyang.websocket.sender-rocketmq.consumer-group}",

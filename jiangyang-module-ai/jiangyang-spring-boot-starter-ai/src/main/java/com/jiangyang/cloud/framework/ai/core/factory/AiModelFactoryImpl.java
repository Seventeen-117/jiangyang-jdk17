package com.jiangyang.cloud.framework.ai.core.factory;
...
import com.jiangyang.cloud.framework.ai.config.JiangYangAiAutoConfiguration;
import com.jiangyang.cloud.framework.ai.config.JiangYangAiProperties;
...
import com.jiangyang.cloud.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.jiangyang.cloud.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
import com.jiangyang.cloud.framework.common.util.spring.SpringUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            JiangYangAiProperties.MidjourneyProperties properties = SpringUtil.getBean(JiangYangAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link JiangYangAiAutoConfiguration#deepSeekChatModel(JiangYangAiProperties)}
     */
    private static DeepSeekChatModel buildDeepSeekChatModel(String apiKey) {
        JiangYangAiProperties.DeepSeekProperties properties = new JiangYangAiProperties.DeepSeekProperties()
                .setApiKey(apiKey);
        return new JiangYangAiAutoConfiguration().buildDeepSeekChatModel(properties);
    }

    /**
     * 可参考 {@link JiangYangAiAutoConfiguration#douBaoChatClient(JiangYangAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        JiangYangAiProperties.DouBaoProperties properties = new JiangYangAiProperties.DouBaoProperties()
                .setApiKey(apiKey);
        return new JiangYangAiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link JiangYangAiAutoConfiguration#hunYuanChatClient(JiangYangAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        JiangYangAiProperties.HunYuanProperties properties = new JiangYangAiProperties.HunYuanProperties()
                .setBaseUrl(url).setApiKey(apiKey);
        return new JiangYangAiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link JiangYangAiAutoConfiguration#siliconFlowChatClient(JiangYangAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        JiangYangAiProperties.SiliconFlowProperties properties = new JiangYangAiProperties.SiliconFlowProperties()
                .setApiKey(apiKey);
        return new JiangYangAiAutoConfiguration().buildSiliconFlowChatClient(properties);
    }
    ...
    /**
     * 可参考 {@link JiangYangAiAutoConfiguration#xingHuoChatClient(JiangYangAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        JiangYangAiProperties.XingHuoProperties properties = new JiangYangAiProperties.XingHuoProperties()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new JiangYangAiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link JiangYangAiAutoConfiguration#baiChuanChatClient(JiangYangAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        JiangYangAiProperties.BaiChuanProperties properties = new JiangYangAiProperties.BaiChuanProperties()
                .setApiKey(apiKey);
        return new JiangYangAiAutoConfiguration().buildBaiChuanChatClient(properties);
    }

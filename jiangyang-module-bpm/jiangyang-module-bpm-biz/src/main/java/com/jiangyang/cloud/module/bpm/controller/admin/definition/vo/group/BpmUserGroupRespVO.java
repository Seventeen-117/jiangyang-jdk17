package com.jiangyang.cloud.module.bpm.controller.admin.definition.vo.group;
...
public class BpmUserGroupRespVO {
    ...
    @Schema(description = "描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "江阳科技")

package com.jiangyang.cloud.module.bpm.service.task;
...
import com.jiangyang.cloud.framework.common.util.object.ObjectUtils;
import com.jiangyang.cloud.framework.common.util.object.PageUtils;
...
import com.jiangyang.cloud.module.bpm.controller.admin.task.vo.instance.*;
import com.jiangyang.cloud.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.jiangyang.cloud.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.jiangyang.cloud.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.jiangyang.cloud.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.jiangyang.cloud.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.jiangyang.cloud.module.bpm.enums.ErrorCodeConstants;
import com.jiangyang.cloud.module.bpm.enums.definition.BpmModelTypeEnum;
import com.jiangyang.cloud.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.jiangyang.cloud.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.jiangyang.cloud.module.bpm.enums.task.BpmReasonEnum;
import com.jiangyang.cloud.module.bpm.enums.task.BpmTaskStatusEnum;
import com.jiangyang.cloud.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.jiangyang.cloud.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.jiangyang.cloud.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.jiangyang.cloud.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.jiangyang.cloud.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.jiangyang.cloud.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.jiangyang.cloud.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.jiangyang.cloud.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.jiangyang.cloud.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.jiangyang.cloud.module.bpm.service.definition.BpmProcessDefinitionService;
import com.jiangyang.cloud.module.bpm.service.message.BpmMessageService;
...
import static com.jiangyang.cloud.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.jiangyang.cloud.module.bpm.enums.ErrorCodeConstants.*;
import static com.jiangyang.cloud.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.jiangyang.cloud.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;

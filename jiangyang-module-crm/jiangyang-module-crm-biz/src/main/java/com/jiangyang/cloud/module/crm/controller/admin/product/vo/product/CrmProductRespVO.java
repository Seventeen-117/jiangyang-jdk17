package com.jiangyang.cloud.module.crm.controller.admin.product.vo.product;
...
import com.jiangyang.cloud.module.crm.enums.DictTypeConstants;
...
public class CrmProductRespVO implements VO {
    ...
    @Schema(description = "负责人的用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "江阳科技")
    @ExcelProperty("负责人")
    ...
    @Schema(description = "创建人名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "江阳科技")
    @ExcelProperty("创建人")

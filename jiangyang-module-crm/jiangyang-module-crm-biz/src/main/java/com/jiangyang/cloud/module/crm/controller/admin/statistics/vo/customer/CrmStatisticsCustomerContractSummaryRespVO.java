package com.jiangyang.cloud.module.crm.controller.admin.statistics.vo.customer;
...
public class CrmStatisticsCustomerContractSummaryRespVO {
    ...
    @Schema(description = "客户名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "江阳科技")
    ...
    @Schema(description = "负责人", requiredMode = Schema.RequiredMode.REQUIRED, example = "江阳科技")

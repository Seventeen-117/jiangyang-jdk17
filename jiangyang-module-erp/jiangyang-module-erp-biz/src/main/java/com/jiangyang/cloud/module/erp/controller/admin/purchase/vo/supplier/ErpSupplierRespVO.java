package com.jiangyang.cloud.module.erp.controller.admin.purchase.vo.supplier;
...
public class ErpSupplierRespVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "江阳科技")
    @ExcelProperty("供应商名称")
    private String name;

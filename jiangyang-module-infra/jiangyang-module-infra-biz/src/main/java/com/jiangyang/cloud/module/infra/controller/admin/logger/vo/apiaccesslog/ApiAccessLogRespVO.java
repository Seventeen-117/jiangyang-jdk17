package com.jiangyang.cloud.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.jiangyang.cloud.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "江阳科技，牛逼！")
    @ExcelProperty("结果提示")

package com.jiangyang.cloud.module.infra.service.codegen.inner;
...
import com.jiangyang.cloud.framework.apilog.core.enums.OperateTypeEnum;
...
import com.jiangyang.cloud.framework.excel.core.annotations.DictFormat;
import com.jiangyang.cloud.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "jiangyang-module-${table.moduleName}/" + // 顶级模块
                "jiangyang-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "jiangyang-module-${table.moduleName}/" + // 顶级模块
                "jiangyang-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "jiangyang-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "jiangyang-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }

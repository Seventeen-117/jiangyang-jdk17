package com.jiangyang.cloud.module.iot.dal.redis;
...
public interface RedisKeyConstants {
     ...
     * VALUE 数据类型：String 数组(JSON)，即 {@link com.jiangyang.cloud.module.iot.dal.dataobject.thingmodel.IotThingModelDO} 列表
     */

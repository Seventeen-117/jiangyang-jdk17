...
import com.jiangyang.cloud.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwareCreateReqVO;
import com.jiangyang.cloud.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwarePageReqVO;
import com.jiangyang.cloud.module.iot.controller.admin.ota.vo.firmware.IotOtaFirmwareUpdateReqVO;
...
import com.jiangyang.cloud.module.iot.dal.mysql.ota.IotOtaFirmwareMapper;
...
import static com.jiangyang.cloud.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_NOT_EXISTS;
import static com.jiangyang.cloud.module.iot.enums.ErrorCodeConstants.OTA_FIRMWARE_PRODUCT_VERSION_DUPLICATE;
...
public class IotOtaFirmwareServiceImpl implements IotOtaFirmwareService {
     ...
     * @throws com.jiangyang.cloud.framework.common.exception.ServiceException，则抛出异常，提示固件信息已存在
     */

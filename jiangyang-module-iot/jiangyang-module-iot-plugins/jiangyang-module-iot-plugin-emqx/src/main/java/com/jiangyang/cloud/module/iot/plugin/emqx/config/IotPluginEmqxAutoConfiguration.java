package com.jiangyang.cloud.module.iot.plugin.emqx.config;
...
import com.jiangyang.cloud.module.iot.plugin.emqx.downstream.IotDeviceDownstreamHandlerImpl;
import com.jiangyang.cloud.module.iot.plugin.emqx.upstream.IotDeviceUpstreamServer;
...
public class IotPluginEmqxAutoConfiguration {
    ...
    public MqttClient mqttClient(Vertx vertx, IotPluginEmqxProperties emqxProperties) {
        MqttClientOptions options = new MqttClientOptions()
                .setClientId("jiangyang-iot-downstream-" + IdUtil.fastSimpleUUID())

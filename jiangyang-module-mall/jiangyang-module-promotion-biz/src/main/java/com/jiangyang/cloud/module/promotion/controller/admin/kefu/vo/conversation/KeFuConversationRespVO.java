package com.jiangyang.cloud.module.promotion.controller.admin.kefu.vo.conversation;
...
public class KeFuConversationRespVO {
    ...
    private Long userId;
    @Schema(description = "会话所属用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://jiangyang.com/images/avatar.jpg")

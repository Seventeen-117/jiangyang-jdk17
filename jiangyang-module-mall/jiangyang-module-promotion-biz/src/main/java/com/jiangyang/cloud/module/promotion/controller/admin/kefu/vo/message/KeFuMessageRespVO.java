package com.jiangyang.cloud.module.promotion.controller.admin.kefu.vo.message;
...
public class KeFuMessageRespVO {
    ...
    @Schema(description = "发送人头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://jiangyang.com/images/avatar.jpg")

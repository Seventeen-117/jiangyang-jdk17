package com.jiangyang.cloud.module.trade.controller.admin.config.vo;
...
public class TradeConfigBaseVO {
    ...
    @Schema(description = "分销海报图地址数组", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.iocoder.cn/jiangyang.jpg]")

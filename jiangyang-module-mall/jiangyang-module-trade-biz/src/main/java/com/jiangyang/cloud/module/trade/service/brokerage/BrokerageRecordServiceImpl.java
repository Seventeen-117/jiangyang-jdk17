...
import com.jiangyang.cloud.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
...
import com.jiangyang.cloud.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import com.jiangyang.cloud.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static com.jiangyang.cloud.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.jiangyang.cloud.framework.common.util.collection.CollectionUtils.getMinValue;
import static com.jiangyang.cloud.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static com.jiangyang.cloud.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;

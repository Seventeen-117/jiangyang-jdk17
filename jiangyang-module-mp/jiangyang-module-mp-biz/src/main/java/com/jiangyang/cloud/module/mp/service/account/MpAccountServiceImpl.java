package com.jiangyang.cloud.module.mp.service.account;
...
import com.jiangyang.cloud.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.jiangyang.cloud.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.jiangyang.cloud.module.mp.convert.account.MpAccountConvert;
import com.jiangyang.cloud.module.mp.dal.dataobject.account.MpAccountDO;
import com.jiangyang.cloud.module.mp.dal.mysql.account.MpAccountMapper;
import com.jiangyang.cloud.module.mp.enums.ErrorCodeConstants;
...
import static com.jiangyang.cloud.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 jiangyang-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }

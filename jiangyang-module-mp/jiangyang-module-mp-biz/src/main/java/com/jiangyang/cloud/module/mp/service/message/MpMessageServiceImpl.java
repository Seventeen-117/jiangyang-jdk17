package com.jiangyang.cloud.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.jiangyang.cloud.framework.common.pojo.PageResult;
import com.jiangyang.cloud.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.jiangyang.cloud.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.jiangyang.cloud.module.mp.convert.message.MpMessageConvert;
import com.jiangyang.cloud.module.mp.dal.dataobject.account.MpAccountDO;
import com.jiangyang.cloud.module.mp.dal.dataobject.message.MpMessageDO;
import com.jiangyang.cloud.module.mp.dal.dataobject.user.MpUserDO;
import com.jiangyang.cloud.module.mp.dal.mysql.message.MpMessageMapper;
import com.jiangyang.cloud.module.mp.enums.message.MpMessageSendFromEnum;
import com.jiangyang.cloud.module.mp.framework.mp.core.MpServiceFactory;
import com.jiangyang.cloud.module.mp.framework.mp.core.util.MpUtils;
import com.jiangyang.cloud.module.mp.service.account.MpAccountService;
import com.jiangyang.cloud.module.mp.service.material.MpMaterialService;
import com.jiangyang.cloud.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.jiangyang.cloud.module.mp.service.user.MpUserService;
...
import static com.jiangyang.cloud.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;

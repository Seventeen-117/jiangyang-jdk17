package com.jiangyang.cloud.module.pay.service.order;
...
import com.jiangyang.cloud.framework.pay.core.client.PayClient;
import com.jiangyang.cloud.framework.pay.core.client.dto.order.PayOrderRespDTO;
import com.jiangyang.cloud.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import com.jiangyang.cloud.framework.pay.core.enums.order.PayOrderStatusRespEnum;
...
import com.jiangyang.cloud.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
...
import com.jiangyang.cloud.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import com.jiangyang.cloud.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import com.jiangyang.cloud.module.pay.dal.mysql.order.PayOrderMapper;
import com.jiangyang.cloud.module.pay.dal.redis.no.PayNoRedisDAO;
import com.jiangyang.cloud.module.pay.enums.notify.PayNotifyTypeEnum;
import com.jiangyang.cloud.module.pay.enums.order.PayOrderStatusEnum;
import com.jiangyang.cloud.module.pay.framework.pay.config.PayProperties;
import com.jiangyang.cloud.module.pay.service.app.PayAppService;
import com.jiangyang.cloud.module.pay.service.channel.PayChannelService;
...
import static com.jiangyang.cloud.framework.common.util.json.JsonUtils.toJsonString;
import static com.jiangyang.cloud.module.pay.enums.ErrorCodeConstants.*;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/jiangyang-cloud/issues/I8SM9H 场景

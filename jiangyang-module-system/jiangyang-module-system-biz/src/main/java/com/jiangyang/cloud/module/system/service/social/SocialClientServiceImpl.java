package com.jiangyang.cloud.module.system.service.social;
...
import com.jiangyang.cloud.framework.common.util.cache.CacheUtils;
...
import com.jiangyang.cloud.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.jiangyang.cloud.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.jiangyang.cloud.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.jiangyang.cloud.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.jiangyang.cloud.module.system.dal.dataobject.social.SocialClientDO;
import com.jiangyang.cloud.module.system.dal.mysql.social.SocialClientMapper;
import com.jiangyang.cloud.module.system.dal.redis.RedisKeyConstants;
import com.jiangyang.cloud.module.system.enums.social.SocialTypeEnum;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${jiangyang.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${jiangyang.wxa-subscribe-message.miniprogram-state:formal}")

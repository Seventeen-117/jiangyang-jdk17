package com.jiangyang.cloud.module.system.service.tenant;
...
import com.jiangyang.cloud.framework.tenant.config.TenantProperties;
...
import com.jiangyang.cloud.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import com.jiangyang.cloud.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.jiangyang.cloud.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.jiangyang.cloud.module.system.convert.tenant.TenantConvert;
...
import com.jiangyang.cloud.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.jiangyang.cloud.module.system.dal.mysql.tenant.TenantMapper;
import com.jiangyang.cloud.module.system.enums.permission.RoleCodeEnum;
import com.jiangyang.cloud.module.system.enums.permission.RoleTypeEnum;
...
import com.jiangyang.cloud.module.system.service.tenant.handler.TenantInfoHandler;
import com.jiangyang.cloud.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 jiangyang.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
